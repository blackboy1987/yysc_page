...
export async function list(body: Record<string, any>, options?: { [key: string]: any }) {
  return request(Constants.apiUrl + 'carousel/list', {
    method: 'POST',
    data: {
      ...body,
...
export async function save(body: Record<string, any>, options?: { [key: string]: any }) {
  ...
  return request(Constants.apiUrl + (body.id ? 'carousel/update' : 'carousel/save'), {
    method: 'POST',
    data: formValues,
    ...(options || {}),
  });
...
export async function remove(body: Record<string, any>, options?: { [key: string]: any }) {
  return request(Constants.apiUrl + 'carousel/delete', {
    method: 'POST',
    data: body,
    ...(options || {}),
  });
