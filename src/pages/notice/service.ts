...
export async function list(body: Record<string, any>, options?: { [key: string]: any }) {
  return request(Constants.apiUrl + 'notice/list', {
    method: 'POST',
    data: {
      ...body,
...
export async function save(body: Record<string, any>, options?: { [key: string]: any }) {
  ...
  return request(Constants.apiUrl + (body.id ? 'notice/update' : 'notice/save'), {
    method: 'POST',
    data: formValues,
    ...(options || {}),
  });
...
export async function remove(body: Record<string, any>, options?: { [key: string]: any }) {
  return request(Constants.apiUrl + 'notice/delete', {
    method: 'POST',
    data: body,
    ...(options || {}),
  });
